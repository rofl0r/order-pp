...
#define ORDER_PP_OUTPUT(s) ORDER_PP_OUTPUT_EMIT_A ORDER_PP_CM(,ORDER_PP_OUTPUT_REV_PAIR_A (,0,)s(0,),8OUTPUT_REV_STOP,))
...
#define ORDER_PP_8OUTPUT_REV_SWAP(P,s,...) (,ORDER_PP_OUTPUT_REV_SWAP_A P##s,P##__VA_ARGS__)
...
#define ORDER_PP_8OUTPUT_REV_STOP(P,s,...) ,ORDER_PP_OUTPUT_REV_SWAP_A P##s)
