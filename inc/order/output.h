...
#define ORDER_PP_OUTPUT(s) ORDER_PP_OUTPUT_EMIT_A ORDER_PP_OUTPUT_SCAN(ORDER_PP_OUTPUT_REVERSE ORDER_PP_BLOCK(,ORDER_PP_OUTPUT_REV_IN_A s(0,)))(0,0,)
...
#define ORDER_PP_OUTPUT_REV_OUT0(...) ORDER_PP_ERROR_ODD_NUMBER_OF_OUTPUT_REVERSAL_TOGGLES(!)
...
#define ORDER_PP_OUTPUT_REV_IN0(...)
#define ORDER_PP_OUTPUT_REV_IN9(...)
#define ORDER_PP_OUTPUT_REV_IN

#define ORDER_PP_ERROR_ODD_NUMBER_OF_OUTPUT_REVERSAL_TOGGLES()

#define ORDER_PP_OUTPUT_REVERSE(P,s) ORDER_PP_CM(ORDER_PP_OUTPUT_REV_PAIR_A P##s(0,),8OUTPUT_REV_EXIT)
