...
#define ORDER_PP_OUTPUT(s) ORDER_PP_OUTPUT_EMIT_A ORDER_PP_CM(,ORDER_PP_OUTPUT_REV_PAIR_A s(0,),8OUTPUT_REV_EXIT,)(0,0,)
...
#define ORDER_PP_OUTPUT_EMIT_A(P,m,...) ORDER_PP_OUTPUT_EMIT_##m(,__VA_ARGS__##P)ORDER_PP_OUTPUT_EMIT_B##P
#define ORDER_PP_OUTPUT_EMIT_A0
#define ORDER_PP_OUTPUT_EMIT_B(P,m,...) ORDER_PP_OUTPUT_EMIT_##m(,__VA_ARGS__##P)ORDER_PP_OUTPUT_EMIT_A##P
