...
#define ORDER_PP_OUTPUT_REVERSE(P,s) ORDER_PP_PM(,ORDER_PP_OUTPUT_REV_PAIR_A P##s(0,),0,)

#define ORDER_PP_8OUTPUT_REV_PAIR(P,s,n,...) (,ORDER_PP_OUTPUT_REV_PAIR_A P##s(0,),ORDER_PP_INC_##n,)
...
#define ORDER_PP_OUTPUT_REV_PAIR_B0(...) ,8OUTPUT_REV_SWAP
...
#define ORDER_PP_OUTPUT_REV_PAIR_D0(...) ),8OUTPUT_REV_SWAP
...
#define ORDER_PP_OUTPUT_REV_PAIR_F0(...) ,8OUTPUT_REV_SWAP
