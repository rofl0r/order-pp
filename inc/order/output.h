...
#define ORDER_PP_OUTPUT_PAIR_E0 (0,),8SEQ_APPLY,ORDER_PP_OUTPUT_PAIR_A,8SEQ_APPLY,ORDER_PP_OUTPUT_SWAP_A
#define ORDER_PP_OUTPUT_PAIR_F(P,...) ,ORDER_PP_EAT_UNLESS_##P(,__VA_ARGS__##P))ORDER_PP_OUTPUT_PAIR_E##P
#define ORDER_PP_OUTPUT_PAIR_F0 (0,),8SEQ_APPLY,ORDER_PP_OUTPUT_PAIR_A,8SEQ_APPLY,ORDER_PP_OUTPUT_SWAP_A
