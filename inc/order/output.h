...
#define ORDER_PP_OUTPUT_PAIR_A(P,...) ORDER_PP_OUTPUT_PAIR_B##P(,__VA_ARGS__##P)
#define ORDER_PP_OUTPUT_PAIR_B(P,...) (,(,P##__VA_ARGS__),ORDER_PP_OUTPUT_PAIR_C
#define ORDER_PP_OUTPUT_PAIR_B0(...)
#define ORDER_PP_OUTPUT_PAIR_C(P,...) ORDER_PP_OUTPUT_PAIR_D##P(,__VA_ARGS__##P)
#define ORDER_PP_OUTPUT_PAIR_D(P,...) (,P##__VA_ARGS__))ORDER_PP_OUTPUT_PAIR_E
#define ORDER_PP_OUTPUT_PAIR_D0(...) )
#define ORDER_PP_OUTPUT_PAIR_E(P,...) ORDER_PP_OUTPUT_PAIR_F##P(,__VA_ARGS__##P)
#define ORDER_PP_OUTPUT_PAIR_F(P,...) (,(,P##__VA_ARGS__),ORDER_PP_OUTPUT_PAIR_G
#define ORDER_PP_OUTPUT_PAIR_F0(...)
#define ORDER_PP_OUTPUT_PAIR_G(P,...) ORDER_PP_OUTPUT_PAIR_H##P(,__VA_ARGS__##P)
#define ORDER_PP_OUTPUT_PAIR_H(P,...) (,P##__VA_ARGS__))ORDER_PP_OUTPUT_PAIR_I
#define ORDER_PP_OUTPUT_PAIR_H0(...) ),8OUTPUT_PAIR
#define ORDER_PP_OUTPUT_PAIR_I(P,...) ORDER_PP_OUTPUT_PAIR_J##P(,__VA_ARGS__##P)
#define ORDER_PP_OUTPUT_PAIR_J(P,...) (,(,P##__VA_ARGS__),ORDER_PP_OUTPUT_PAIR_G
#define ORDER_PP_OUTPUT_PAIR_J0(...) ,8OUTPUT_PAIR
