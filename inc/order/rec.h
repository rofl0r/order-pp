...
#define ORDER_PP_EVAL_0(t) ORDER_PP_SCAN_0(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_1(t) ORDER_PP_SCAN_1(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_2(t) ORDER_PP_SCAN_2(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_3(t) ORDER_PP_SCAN_3(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_4(t) ORDER_PP_SCAN_4(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_5(t) ORDER_PP_SCAN_5(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_6(t) ORDER_PP_SCAN_6(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_7(t) ORDER_PP_SCAN_7(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_8(t) ORDER_PP_SCAN_8(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_9(t) ORDER_PP_SCAN_9(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_10(t) ORDER_PP_SCAN_10(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_11(t) ORDER_PP_SCAN_11(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_12(t) ORDER_PP_SCAN_12(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_13(t) ORDER_PP_SCAN_13(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_14(t) ORDER_PP_SCAN_14(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_15(t) ORDER_PP_SCAN_15(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_16(t) ORDER_PP_SCAN_16(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_17(t) ORDER_PP_SCAN_17(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_18(t) ORDER_PP_SCAN_18(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_19(t) ORDER_PP_SCAN_19(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_20(t) ORDER_PP_SCAN_20(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_21(t) ORDER_PP_SCAN_21(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_22(t) ORDER_PP_SCAN_22(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_23(t) ORDER_PP_SCAN_23(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_24(t) ORDER_PP_SCAN_24(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_25(t) ORDER_PP_SCAN_25(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_26(t) ORDER_PP_SCAN_26(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_27(t) ORDER_PP_SCAN_27(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_28(t) ORDER_PP_SCAN_28(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_29(t) ORDER_PP_SCAN_29(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_30(t) ORDER_PP_SCAN_30(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_31(t) ORDER_PP_SCAN_31(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_32(t) ORDER_PP_SCAN_32(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_33(t) ORDER_PP_SCAN_33(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_34(t) ORDER_PP_SCAN_34(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_35(t) ORDER_PP_SCAN_35(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_36(t) ORDER_PP_SCAN_36(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_37(t) ORDER_PP_SCAN_37(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_38(t) ORDER_PP_SCAN_38(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_39(t) ORDER_PP_SCAN_39(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_40(t) ORDER_PP_SCAN_40(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_41(t) ORDER_PP_SCAN_41(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_42(t) ORDER_PP_SCAN_42(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_43(t) ORDER_PP_SCAN_43(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_44(t) ORDER_PP_SCAN_44(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_45(t) ORDER_PP_SCAN_45(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_46(t) ORDER_PP_SCAN_46(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_47(t) ORDER_PP_SCAN_47(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_48(t) ORDER_PP_SCAN_48(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_49(t) ORDER_PP_SCAN_49(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_50(t) ORDER_PP_SCAN_50(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_51(t) ORDER_PP_SCAN_51(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_52(t) ORDER_PP_SCAN_52(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_53(t) ORDER_PP_SCAN_53(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_54(t) ORDER_PP_SCAN_54(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_55(t) ORDER_PP_SCAN_55(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_56(t) ORDER_PP_SCAN_56(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_57(t) ORDER_PP_SCAN_57(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_58(t) ORDER_PP_SCAN_58(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_59(t) ORDER_PP_SCAN_59(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_60(t) ORDER_PP_SCAN_60(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_61(t) ORDER_PP_SCAN_61(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#define ORDER_PP_EVAL_62(t) ORDER_PP_SCAN_62(ORDER_PP_OUTPUT(ORDER_PP_CM(,,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EXIT,)))
#else
