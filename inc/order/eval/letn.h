...
# define ORDER_PP_8EVAL_LETN(P,e,s0,i0,bs,t,G,...) (,P##e,ORDER_PP_SYNTAX_CHECK(,P##i0,ORDER_PP_DEF)(P##i0),8EVAL_LETN_LOOP,P##s0,P##e,ORDER_PP_SEQ_AT_0 bs##P,P##t,P##__VA_ARGS__)
# define ORDER_PP_8EVAL_LETN_LOOP(P,v0,s0,e,s1,i1,bs,...) (,(,P##s0,P##v0)P##e,ORDER_PP_SYNTAX_CHECK(,P##i1,ORDER_PP_DEF)(P##i1),8EVAL_LETN_LOOP,P##s1,(,P##s0,P##v0)P##e,ORDER_PP_SEQ_AT_0 bs##P,P##__VA_ARGS__)
#else
...
#ifdef ORDER_PP_DEBUG
# define ORDER_PP_0EVAL_LETN(P,e,G,eval_letn_loop,s1,e2,split_bs,t,...) (,P##e,ORDER_PP_SYNTAX_CHECK(,P##t,ORDER_PP_DEF)(P##t),P##__VA_ARGS__)
#else
