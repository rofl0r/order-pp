...
#define ORDER_PP_8EVAL_LET(P,e,s0,i0,bs,t,G,...) (,P##e,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##i0())ORDER_PP_DEF_##i0,8EVAL_LET_LOOP,P##s0,,P##e,ORDER_PP_SEQ_AT_0 bs##P,P##t,P##__VA_ARGS__)
