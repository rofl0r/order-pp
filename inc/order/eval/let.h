...
#define ORDER_PP_8EVAL_LET(P,e,s,i,b,G,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##i())ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##b())(,P##e,ORDER_PP_DEF_##i,8EVAL_LET_B,P##s,P##e,P##b,P##__VA_ARGS__)
#else
