...
#define ORDER_PP_8EVAL_IREF(P,e,s,G,...) (,ORDER_PP_8EVAL_IREF_B(,ORDER_PP_REF_##s e##P,P##s),P##__VA_ARGS__)
#define ORDER_PP_8EVAL_IREF_B(P,x,s) ORDER_PP_TUPLE_AT_1(,x,ORDER_PP_ERROR_UNBOUND_VARIABLE ORDER_PP_COMMA 8EXIT_ERROR ORDER_PP_COMMA P##s,)
#else
#define ORDER_PP_8EVAL_IREF(P,e,s,G,K,...) ORDER_PP_INVOKE(P##K,ORDER_PP_8EVAL_IREF_B(ORDER_PP_REF_##s e##P)),P##__VA_ARGS__)
