...
#define ORDER_PP_ENV_REF(P,s0,e) ORDER_PP_FX(TUPLE_AT_0,(,ORDER_PP_SCAN(ORDER_PP_SCAN(ORDER_PP_ENV_REF_A P##e(0,,)P##s0,ORDER_PP_ENV_CLOSE_A P##e(0,,))),ORDER_PP_ERROR_UNBOUND_VARIABLE ORDER_PP_BLOCK(!),))
...
#define ORDER_PP_DEF_8call_ce(t) 8CALL_CE,t,
#define ORDER_PP_8CALL_CE(P,e,t,G,...) (,P##e,ORDER_PP_DEF_##t,8AP,P##e,P##__VA_ARGS__)
