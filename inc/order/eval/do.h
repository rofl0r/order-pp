...
#define ORDER_DEF_do(...) 8EVAL_DO,ORDER_PP_NUM_ARGS_8(__VA_ARGS__,8,7,6,5,4,3,2,1,0,),__VA_ARGS__

#define ORDER_CM_8EVAL_DO(P,e,n,t,...) (,P##e,ORDER_DEF_##t,8EVAL_DO_##n,P##e,P##__VA_ARGS__)

#define ORDER_CM_8EVAL_DO_0(P,v,e,K,...) ORDER_CM_##K(,P##v,P##__VA_ARGS__)
#define ORDER_CM_8EVAL_DO_1(P,_,e,...) (,P##e,ORDER_DEF_##__VA_ARGS__)
