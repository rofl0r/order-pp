...
#define ORDER_PP_8EVAL_TUPLE(P,e,ts,G,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_FIRST P##ts())(,P##e,ORDER_PP_DEF_FIRST P##ts,8EVAL_TUPLE_B,,P##e,ORDER_PP_TUPLE_REST P##ts,P##__VA_ARGS__)
#define ORDER_PP_8EVAL_TUPLE_B(P,v,s,e,t,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())(,P##e,ORDER_PP_DEF_##t,8EVAL_TUPLE_B,P##s(,P##v),P##e,P##__VA_ARGS__)
#else
...
#define ORDER_PP_0EVAL_TUPLE(P,e1,G,eval_tuple_b,s,e2,K,...) ORDER_PP_##K(,(ORDER_PP_FY(TUPLE_REST_0,(ORDER_PP_SEQ_TERMINATE(ORDER_PP_EVAL_TUPLE_A P##s)))),P##__VA_ARGS__)
