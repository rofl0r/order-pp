...
# define ORDER_PP_8EVAL_OR_LOOP(P,b,e,ts,...) (,ORDER_PP_TYPE_CHECK(,0IS_BOOL,P##b,ORDER_PP_PRIMITIVE_CAT)(ORDER_PP_IF_,P##b)(,8true,P##e,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_FIRST ts##P())ORDER_PP_DEF_FIRST ts##P ORDER_PP_IS_TUPLE_SIZE_1 ts##P(,,,8EVAL_OR_LOOP,P##e,(,ORDER_PP_TUPLE_REST ts##P))),P##__VA_ARGS__)
#else
