...
#define ORDER_PP_8EVAL_PRINT_EVAL(P,expr,e,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##expr())(,P##e,ORDER_PP_DEF_##expr,8EVAL_PRINT_PUT,ORDER_PP_FX(TUPLE_LAST,(,ORDER_PP_DEF_##expr)),P##e,P##__VA_ARGS__)
#else
