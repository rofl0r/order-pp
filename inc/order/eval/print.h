...
#define ORDER_PP_8EVAL_PARENTHESIZED(P,e,expr,G,...) ORDER_PP_IS_EDIBLE(,P##expr)(ORDER_PP_8EVAL_PRINT_,QUOTE,EVAL)(,expr##P 8print0,e##P,8RPAREN,,P##__VA_ARGS__)(,1L,)
...
#define ORDER_PP_8EVAL_PRINT_QUOTE(P,expr,...) (,ORDER_PP_EAT expr##P,8EVAL_PRINT_LOOP,P##__VA_ARGS__)(,1,ORDER_PP_OPEN ORDER_PP_FX(,ORDER_PP_TUPLE_AT_0,(,ORDER_PP_8EVAL_PRINT_QUOTE_SPLIT expr##P)))
...
#define ORDER_PP_8LPAREN(P,e,G,K,...) ORDER_PP_##K(,,P##__VA_ARGS__)(,1L,)
...
#define ORDER_PP_8COMMA(P,e,G,K,...) ORDER_PP_##K(,,P##__VA_ARGS__)(,1,,)
...
#define ORDER_PP_8RPAREN(P,e,G,K,...) ORDER_PP_##K(,,P##__VA_ARGS__)(,1R,)
