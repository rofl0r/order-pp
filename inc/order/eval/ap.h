...
#define ORDER_PP_8EVAL_AP_9(P,f,e,t,...)   ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())(,P##e,ORDER_PP_DEF_##t,ORDER_PP_OPEN f##P,8EVAL_AP_8,P##e,P##__VA_ARGS__)
#define ORDER_PP_8EVAL_AP_10(P,f,e,t,...)  ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())(,P##e,ORDER_PP_DEF_##t,ORDER_PP_OPEN f##P,8EVAL_AP_9,P##e,P##__VA_ARGS__)
