...
#define ORDER_DEF_ap(...) 8EVAL_AP,ORDER_PP_NUM_ARGS_8(__VA_ARGS__,8,7,6,5,4,3,2,1,ORDER_PARAMS,),__VA_ARGS__

#define ORDER_CM_8EVAL_AP(P,e,n,ft,...) (,P##e,ORDER_DEF_##ft,8EVAL_AP_##n,P##e,P##__VA_ARGS__)

#define ORDER_CM_8EVAL_AP_ORDER_PARAMS(P,f,e,...) (,P##f,P##__VA_ARGS__)
