...
#define ORDER_PP_8EVAL_AP_6(P,f,e,t,...)   ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())(,P##e,ORDER_PP_DEF_##t,ORDER_PP_OPEN f##P,8EVAL_AP_5,P##e,P##__VA_ARGS__)
#define ORDER_PP_8EVAL_AP_7(P,f,e,t,...)   ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())(,P##e,ORDER_PP_DEF_##t,ORDER_PP_OPEN f##P,8EVAL_AP_6,P##e,P##__VA_ARGS__)
#define ORDER_PP_8EVAL_AP_8(P,f,e,t,...)   ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())(,P##e,ORDER_PP_DEF_##t,ORDER_PP_OPEN f##P,8EVAL_AP_7,P##e,P##__VA_ARGS__)
#else
...
#define ORDER_PP_8EVAL_AP_6(P,f,e,t,...)   (,P##e,ORDER_PP_DEF_##t,ORDER_PP_OPEN f##P,8EVAL_AP_5,P##e,P##__VA_ARGS__)
#define ORDER_PP_8EVAL_AP_7(P,f,e,t,...)   (,P##e,ORDER_PP_DEF_##t,ORDER_PP_OPEN f##P,8EVAL_AP_6,P##e,P##__VA_ARGS__)
#define ORDER_PP_8EVAL_AP_8(P,f,e,t,...)   (,P##e,ORDER_PP_DEF_##t,ORDER_PP_OPEN f##P,8EVAL_AP_7,P##e,P##__VA_ARGS__)
#endif
