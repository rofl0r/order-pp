...
#define ORDER_PP_8EVAL_COND_LOOP(P,b0,ct0,bt1,ct1,ts,e,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##ct0())ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##bt1())(,P##e,ORDER_PP_IF_##b0(ORDER_PP_DEF_,P##ct0,P##bt1,8EVAL_COND_LOOP,P##ct1,ORDER_PP_EVAL_COND_SPLIT P##ts,P##e),P##__VA_ARGS__)
#else
