...
# define ORDER_PP_8EVAL_COND(P,e,bt,ct,ts,G,...) (,P##e,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##bt())ORDER_PP_DEF_##bt,8EVAL_COND_LOOP,P##ct,ORDER_PP_EVAL_COND_SPLIT P##ts,P##e,P##__VA_ARGS__)
# define ORDER_PP_8EVAL_COND_LOOP(P,b0,ct0,bt1,ct1,ts,e,...) (,P##e,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_IF_##b0(ORDER_PP_DEF_,P##ct0,P##bt1)())ORDER_PP_IF_##b0(ORDER_PP_DEF_,P##ct0,P##bt1,8EVAL_COND_LOOP,P##ct1,ORDER_PP_EVAL_COND_SPLIT P##ts,P##e),P##__VA_ARGS__)
#else
...
#ifdef ORDER_PP_DEBUG
# define ORDER_PP_0EVAL_ELSE(P,e,G,eval_cond_loop,ct,bt1,ct1,ts,e1,...) (,P##e,ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##ct())ORDER_PP_DEF_##ct,P##__VA_ARGS__)
#else
