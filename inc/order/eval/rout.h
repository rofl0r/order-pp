...
// For example,
//
//   8rout(8emitq(1),8emitq(2)) ==> 2 1
//
// Uses of `8rout' can be nested. For example,
//
//   8rout(8emitq(1),
//         8rout(8emitq(2),8emitq(3)),
//         8emitq(4)) ==> 4 2 3 1
//
...
#define ORDER_PP_8EVAL_ROUT(P,e,p,...) (,P##e,ORDER_PP_DEF_8do P##p,8EVAL_ROUT_B,P##__VA_ARGS__)(,1T,)
#define ORDER_PP_8EVAL_ROUT_B(P,x,...) (,P##x,P##__VA_ARGS__)(,1T,)
