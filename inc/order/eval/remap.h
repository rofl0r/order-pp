...
#define ORDER_PP_DEF_8remap(t,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t())ORDER_PP_DEF_##t,8EVAL_REMAP,ORDER_PP_IS_TUPLE_SIZE_1(,0##__VA_ARGS__)(ORDER_PP_REMAP_,NONE,SOME)(,__VA_ARGS__),
#else
...
#define ORDER_PP_8EVAL_REMAP(P,f,n,is,G,...) (,(,8REMAP_FST,P##f,ORDER_PP_LIT_DEC(,P##n),P##is),P##__VA_ARGS__)
