...
#define ORDER_PP_CM_ERROR_0(P,_,x) ORDER_PP_CM_SCAN_0(ORDER_PP_CM_SCAN_0(ORDER_PP_CM_OUTPUT(,(,1,P##x)
#define ORDER_PP_CM_ERROR_1(P,_,x) ORDER_PP_CM_SCAN_1(ORDER_PP_CM_SCAN_1(ORDER_PP_CM_OUTPUT(,(,1,P##x)
#define ORDER_PP_CM_ERROR_2(P,_,x) ORDER_PP_CM_SCAN_2(ORDER_PP_CM_SCAN_2(ORDER_PP_CM_OUTPUT(,(,1,P##x)
#define ORDER_PP_CM_ERROR_3(P,_,x) ORDER_PP_CM_SCAN_3(ORDER_PP_CM_SCAN_3(ORDER_PP_CM_OUTPUT(,(,1,P##x)

#define ORDER_PP_CM_OUTPUT(P,s) ORDER_PP_CM_EMIT_A ORDER_PP_CM_REV_A P##s(0,0,)(0,0,)
