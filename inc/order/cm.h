...
#define ORDER_PP_CM_OUTPUT(P,s) ORDER_PP_CM_OUTPUT_B(ORDER_PP_CM_OUTPUT_OPEN_A P##s(0,0,)ORDER_PP_CM_OUTPUT_CLOSE_A P##s(0,))
#define ORDER_PP_CM_OUTPUT_B(s) ORDER_PP_CM_EMIT_A s(0,0,)
