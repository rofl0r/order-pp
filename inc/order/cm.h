...
#define ORDER_PP_CM_FIND_SCAN_4(...) 8ERROR_CM_RECURSION_TOO_DEEP

#define ORDER_PP_CM_GO(i) ORDER_PP_CM_##i ORDER_PP_EAT()
...
#define ORDER_PP_CM_OUTPUT(P,s) ORDER_PP_CM_EMIT_A ORDER_PP_CM_SCAN(ORDER_PP_CM_OUTPUT_OPEN_A P##s(0,0,)ORDER_PP_CM_OUTPUT_CLOSE_A P##s(0,,)(0,0,))

#define ORDER_PP_CM_SCAN(...) __VA_ARGS__

#define ORDER_PP_CM_OUTPUT_OPEN_A(P,...) ORDER_PP_CM_REV ORDER_PP_EAT()(,(,P##__VA_ARGS__),ORDER_PP_CM_OUTPUT_OPEN_B##P
#define ORDER_PP_CM_OUTPUT_OPEN_B(P,...) ORDER_PP_CM_REV ORDER_PP_EAT()(,(,P##__VA_ARGS__),ORDER_PP_CM_OUTPUT_OPEN_A##P
...
#define ORDER_PP_CM_REV(P,l,r) r P##l

#define ORDER_PP_CM_EMIT(...) ORDER_PP_CM_EMIT_A 
