...
#define ORDER_PP_8EQUAL(P,x,y,...) (,ORDER_PP_TEST(,ORDER_PP_SYM_##x##_##y(,),8true,8false),P##__VA_ARGS__)

#define ORDER_PP_DEF_8not_eq ORDER_PP_FN_CM(2,8NOT_EQ)
#define ORDER_PP_8NOT_EQ(P,x,y,...) (,ORDER_PP_TEST(,ORDER_PP_SYM_##x##_##y(,),8false,8true),P##__VA_ARGS__)
