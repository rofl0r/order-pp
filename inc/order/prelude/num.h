...
#define ORDER_PP_DEF_8max ORDER_PP_FN_NATIVE(2,9MAX,0IS_NUM,0IS_NUM)
#define ORDER_PP_9MAX(P,l,r) ORDER_PP_NUM_LESS(,P##l,P##r)(,P##r,P##l)

#define ORDER_PP_DEF_8min ORDER_PP_FN_NATIVE(2,9MIN,0IS_NUM,0IS_NUM)
#define ORDER_PP_9MIN(P,l,r) ORDER_PP_NUM_LESS(,P##r,P##l)(,P##r,P##l)
...
#define ORDER_PP_DEF_8sq ORDER_PP_FN(8fn(8X,8mul(8X,8X)))
...
#define ORDER_PP_0IS_NUM(P,x) ORDER_PP_OR(or)(ORDER_PP_0IS_LIT(,P##x))(or)(ORDER_PP_0IS_NAT(,P##x))()
