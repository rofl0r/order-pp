...
#define ORDER_PP_NUM_BOP(P,op,x,y) ORDER_PP_SELECT_4(ORDER_PP_IS_EDIBLE(,P##x),ORDER_PP_IS_EDIBLE(,P##y))(ORDER_PP_NUM_BOP_,NAT_NAT,NAT_LIT,LIT_NAT,LIT_LIT)(,P##op,P##x,P##y)
