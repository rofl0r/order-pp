...
#define ORDER_PP_DEF_8and_chain ORDER_PP_OP_LEFT_NATIVE(9AND_COMPOSE)

#define ORDER_PP_DEF_8and_compose ORDER_PP_FN_NATIVE(2,9AND_COMPOSE)
...
#define ORDER_PP_DEF_8or_chain ORDER_PP_OP_LEFT_NATIVE(9OR_COMPOSE)

#define ORDER_PP_DEF_8or_compose ORDER_PP_FN_NATIVE(2,9OR_COMPOSE)
