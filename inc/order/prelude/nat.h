...
#define ORDER_PP_8P_NAT(P,t,...) ORDER_PP_IS_TUPLE_SIZE_LT_10 t##P(,ORDER_PP_8EXIT(,ORDER_PP_CAT(ORDER_PP_NAT_,ORDER_PP_TUPLE_SIZE_MAX_10 t##P)t##P,),(,(,ORDER_PP_TUPLE_REST_N_10 t##P),8P_NAT,)ORDER_PP_NAT_FIRST_10 t##P)
