...
// TBD: 0IS_NAT
#define ORDER_PP_0IS_NAT(P,x) ORDER_PP_IF_8true
...
#define ORDER_PP_NAT_TO_LIT_C(d) (ORDER_PP_PRIMITIVE_REVERSE_CAT ORDER_PP_BLOCK(ORDER_PP_NAT_DIGIT_##d,ORDER_PP_NAT_IS_SENTINEL_##d(,ORDER_PP_RPAREN ORDER_PP_RPAREN ORDER_PP_OPEN(,,8SEQ_CAT_REVERSE_LOOP),ORDER_PP_NAT_TO_LIT_D)
...
#define ORDER_PP_NAT_TO_LIT_E(d) (ORDER_PP_PRIMITIVE_REVERSE_CAT ORDER_PP_BLOCK(ORDER_PP_NAT_DIGIT_##d,ORDER_PP_NAT_IS_SENTINEL_##d(,ORDER_PP_RPAREN ORDER_PP_RPAREN()ORDER_PP_OPEN(,,8SEQ_CAT_REVERSE_LOOP),ORDER_PP_NAT_TO_LIT_F)
