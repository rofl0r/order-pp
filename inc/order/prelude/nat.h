...
#define ORDER_PP_SEQ_OF_DIGITS_TO_NAT(P,s) ORDER_PP_FY(9SEQ_REVERSE,(,ORDER_PP_SEQ_OF_DIGITS_TO_NAT_F P##s))
...
#define ORDER_PP_NAT_CHAOS_BOP(P,op,l,r) ORDER_PP_FZ(SEQ_OF_DIGITS_TO_NAT,(,CHAOS_PP_ARBITRARY_##op(ORDER_PP_NAT_TO_SEQ_OF_DIGITS(,P##l),ORDER_PP_NAT_TO_SEQ_OF_DIGITS(,P##r))))
#define ORDER_PP_NAT_CHAOS_BPR(P,pr,l,r) ORDER_PP_OVERLOAD(NAT_CHAOS_BPR,CHAOS_PP_ARBITRARY_##pr(ORDER_PP_NAT_TO_SEQ_OF_DIGITS(,P##l),ORDER_PP_NAT_TO_SEQ_OF_DIGITS(,P##r)))
