...
#define ORDER_PP_DEF_8nat_dec ORDER_PP_FN_NATIVE(1,9NAT_DEC)
#define ORDER_PP_9NAT_DEC(P,n) ORDER_PP_NAT_PRED n##P
...
#define ORDER_PP_DEF_8nat_inc ORDER_PP_FN_NATIVE(1,9NAT_INC)
#define ORDER_PP_9NAT_INC(P,n) ORDER_PP_NAT_SUCC n##P
...
#define ORDER_PP_DEF_8nat_is_0 ORDER_PP_FN_NATIVE(1,9NAT_IS_0)
#define ORDER_PP_9NAT_IS_0(P,x) ORDER_PP_NAT_IS_ZERO x##P(,8true,8false)

#define ORDER_PP_DEF_8nat_isnt_0 ORDER_PP_FN_NATIVE(1,9NAT_ISNT_0)
#define ORDER_PP_9NAT_ISNT_0(P,x) ORDER_PP_NAT_IS_ZERO x##P(,8false,8true)
...
#define ORDER_PP_9NAT_MINUS(P,l,r) ORDER_PP_NAT_MINUS(,P##l,P##r)
...
#define ORDER_PP_9NAT_PLUS(P,l,r) ORDER_PP_NAT_PLUS(,P##l,P##r)

#define ORDER_PP_DEF_8nat_quotient ORDER_PP_FN_NATIVE(2,9NAT_QUOTIENT)
#define ORDER_PP_9NAT_QUOTIENT(P,l,r) ORDER_PP_NAT_DIV(,P##l,P##r)

#define ORDER_PP_DEF_8nat_remainder ORDER_PP_FN_NATIVE(2,9NAT_REMAINDER)
#define ORDER_PP_9NAT_REMAINDER(P,l,r) ORDER_PP_NAT_REMAINDER(,P##l,P##r)
...
#define ORDER_PP_9NAT_TIMES(P,l,r) ORDER_PP_NAT_MUL(,P##l,P##r)

#define ORDER_PP_DEF_8nat_to_lit ORDER_PP_FN_NATIVE(1,9NAT_TO_LIT)
#define ORDER_PP_9NAT_TO_LIT(P,n) ORDER_PP_NAT_TO_LIT(,P##n)
