...
#define ORDER_PP_SEQ_CAT_A(x) (ORDER_PP_CAT ORDER_PP_BLOCK(x,ORDER_PP_SEQ_CAT_B
#define ORDER_PP_SEQ_CAT_A0 ,8STOP
#define ORDER_PP_SEQ_CAT_B(x) x))ORDER_PP_SEQ_CAT_C
#define ORDER_PP_SEQ_CAT_C(x) (ORDER_PP_CAT ORDER_PP_BLOCK(x,ORDER_PP_SEQ_CAT_D
#define ORDER_PP_SEQ_CAT_C0 ,8STOP_REM
#define ORDER_PP_SEQ_CAT_D(x) x))ORDER_PP_SEQ_CAT_E
#define ORDER_PP_SEQ_CAT_E(x) (ORDER_PP_CAT ORDER_PP_BLOCK(x,ORDER_PP_SEQ_CAT_F
#define ORDER_PP_SEQ_CAT_E0 ,8SEQ_CAT_LOOP
#define ORDER_PP_SEQ_CAT_F(x) x))ORDER_PP_SEQ_CAT_G
#define ORDER_PP_SEQ_CAT_G(x) (ORDER_PP_CAT ORDER_PP_BLOCK(x,ORDER_PP_SEQ_CAT_H
...
#define ORDER_PP_SEQ_CAT_REVERSE_C(x) (ORDER_PP_REVERSE_CAT ORDER_PP_BLOCK(x,ORDER_PP_SEQ_CAT_REVERSE_D
#define ORDER_PP_SEQ_CAT_REVERSE_C0 ,8STOP_REM
#define ORDER_PP_SEQ_CAT_REVERSE_D(x) x))ORDER_PP_SEQ_CAT_REVERSE_E
#define ORDER_PP_SEQ_CAT_REVERSE_E(x) (ORDER_PP_REVERSE_CAT ORDER_PP_BLOCK(x,ORDER_PP_SEQ_CAT_REVERSE_F
#define ORDER_PP_SEQ_CAT_REVERSE_E0 ,8SEQ_CAT_REVERSE_LOOP
#define ORDER_PP_SEQ_CAT_REVERSE_F(x) x))ORDER_PP_SEQ_CAT_REVERSE_G
#define ORDER_PP_SEQ_CAT_REVERSE_G(x) (ORDER_PP_REVERSE_CAT ORDER_PP_BLOCK(x,ORDER_PP_SEQ_CAT_REVERSE_H
