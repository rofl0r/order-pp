...
#define ORDER_PP_8SEQ_AT(P,i,s,...) (,ORDER_PP_FX(,ORDER_PP_SEQ_AT,(,0,ORDER_PP_FX(,ORDER_PP_TUPLE_AT_1,(,ORDER_PP_SEQ_SPLIT_AT(,P##i,P##s),)))),P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_FIRST_N(P,n,s,...) (,ORDER_PP_FX(,ORDER_PP_TUPLE_AT_0,(,ORDER_PP_SEQ_SPLIT_AT(,P##n,P##s),)),P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_POP_AT(P,i,s,...) (,ORDER_PP_FX(,ORDER_PP_SEQ_POP_AT_B,(,ORDER_PP_SEQ_SPLIT_AT(,P##i,P##s),)),P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_PUSH_AT(P,i,s,x,...) (,ORDER_PP_FX(,ORDER_PP_SEQ_PUSH_AT_B,(,P##x,ORDER_PP_SEQ_SPLIT_AT(,P##i,P##s),)),P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_RANGE(P,i,n,s,...) (,ORDER_PP_FX(,ORDER_PP_TUPLE_AT_0,(,ORDER_PP_FX(,ORDER_PP_SEQ_SPLIT_AT,(,P##n,ORDER_PP_FX(,ORDER_PP_TUPLE_AT_1,(,ORDER_PP_SEQ_SPLIT_AT(,P##i,P##s),)))),)),P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_REST_N(P,n,s,...) (,ORDER_PP_FX(,ORDER_PP_TUPLE_AT_1,(,ORDER_PP_SEQ_SPLIT_AT(,P##n,P##s),)),P##__VA_ARGS__)

#define ORDER_PP_DEF_8seq_reverse ORDER_PP_FN_CM(1,8SEQ_REVERSE)
#define ORDER_PP_8SEQ_REVERSE(P,s,...) (,ORDER_PP_PM(,ORDER_PP_SEQ_REV_PAIR_A s##P(0,),8SEQ_REV_PAIR,0,),P##__VA_ARGS__)
#define ORDER_PP_8SEQ_REV_PAIR(P,s,n,...) ORDER_PP_IS_SEQ_SIZE_LESS_EQ_1(,P##s)(ORDER_PP_,8SEQ_REV_SWAP,8SEQ_REV_PAIR_CONT)(,P##s,P##n,)
#define ORDER_PP_8SEQ_REV_PAIR_CONT(P,s,n,...) (,ORDER_PP_SEQ_REV_PAIR_A P##s(0,),8SEQ_REV_PAIR,ORDER_PP_INC_##n,)
...
#define ORDER_PP_8SEQ_REV_SWAP(P,s,n,...) ORDER_PP_IS_0_##n(,ORDER_PP_8EXIT,)(,ORDER_PP_SEQ_TERMINATE(ORDER_PP_SEQ_REV_SWAP_A P##s),8SEQ_REV_SWAP,ORDER_PP_DEC_##n,)
...
#define ORDER_PP_8SEQ_SET(P,i,s,x,...) (,ORDER_PP_FX(,ORDER_PP_SEQ_SET_B,(,P##x,ORDER_PP_SEQ_SPLIT_AT(,P##i,P##s),)),P##__VA_ARGS__)
...
#define ORDER_PP_SEQ_SIZE(P,s) ORDER_PP_SCAN(ORDER_PP_SEQ_SIZE_A P##s(0,)()ORDER_PP_SEQ_CLOSE_A P##s(0,))
...
#define ORDER_PP_IS_SEQ_SIZE_LESS_EQ_1(P,s) ORDER_PP_FX(,ORDER_PP_TUPLE_AT_0,(,ORDER_PP_IS_SEQ_SIZE_LESS_EQ_1_TEST P##s(0,)(0,)))
#define ORDER_PP_IS_SEQ_SIZE_LESS_EQ_1_TEST(...) ORDER_PP_SEQ_IS_NIL_TEST
