...
#define ORDER_PP_DEF_8seq_append ORDER_PP_OP_LEFT_NATIVE(9SEQ_APPEND)
#define ORDER_PP_9SEQ_APPEND(P,l,r) ORDER_PP_LEFT(,l##P)P##r
...
#define ORDER_PP_9SEQ_REST_N(P,n,s) ORDER_PP_IS_EDIBLE(,P##n)(ORDER_PP_9SEQ_REST_N_,NAT,LIT)(,P##n,P##s)
#define ORDER_PP_9SEQ_REST_N_LIT(P,n,s) ORDER_PP_FX(TUPLE_AT_1,(,ORDER_PP_SEQ_SPLIT_AT_##n P##s,))
#define ORDER_PP_9SEQ_REST_N_NAT(P,n,s) ORDER_PP_FY(9SEQ_REST_N_LIT,(,ORDER_PP_SCAN(ORDER_PP_NAT_MOD_100_LIT P##n),ORDER_PP_PM(ORDER_PP_NAT_DIV_100 P##n,8SEQ_REST_100N,,P##s)))
#define ORDER_PP_8SEQ_REST_100N(P,n,_,s,...) ORDER_PP_NAT_IS_ZERO P##n(,ORDER_PP_8SEQ_REST_100N_EXIT,)(,ORDER_PP_NAT_PRED P##n,8SEQ_REST_100N,ORDER_PP_SEQ_SPLIT_AT_100 P##s,)
#define ORDER_PP_8SEQ_REST_100N_EXIT(P,n,seq_rest_100n,s,...) ,ORDER_PP_##s)
#define ORDER_PP_ORDER_PP_SEQ_SPLIT_AT_100
...
#define ORDER_PP_9SEQ_SIZE(P,s) ORDER_PP_FX(PSEQ_SIZE,(,ORDER_PP_SEQ_TO_PSEQ(,P##s)))
#define ORDER_PP_PSEQ_SIZE(P,s) ORDER_PP_SCAN(ORDER_PP_PSEQ_SIZE_A P##s(0,)()ORDER_PP_PSEQ_CLOSE_A P##s(0,))
#define ORDER_PP_PSEQ_SIZE_A(P,x) ORDER_PP_PSEQ_SIZE_F ORDER_PP_BLOCK(ORDER_PP_PSEQ_SIZE_B##P
#define ORDER_PP_PSEQ_SIZE_A0
#define ORDER_PP_PSEQ_SIZE_B(P,x) ORDER_PP_PSEQ_SIZE_F ORDER_PP_BLOCK(ORDER_PP_PSEQ_SIZE_A##P
...
#define ORDER_PP_8SEQ_FOR_EACH(P,f,s,...) ORDER_PP_8SEQ_FOR_EACH_3(,,P##f,P##s,P##__VA_ARGS__)
...
#define ORDER_PP_DEF_8seq_for_each_with_idx ORDER_PP_FN_CM(2,8SEQ_FOR_EACH_WITH_IDX)
#define ORDER_PP_8SEQ_FOR_EACH_WITH_IDX(P,f,s,...) ORDER_PP_8SEQ_FOR_EACH_WITH_IDX_LIT(,,0,P##f,P##s,P##__VA_ARGS__)
#define ORDER_PP_8SEQ_FOR_EACH_WITH_IDX_LIT(P,_,i,f,s,...) (,ORDER_PP_SEQ_IS_NIL(,P##s)(,,P##i,ORDER_PP_OPEN f##P,8AP,ORDER_PP_SEQ_AT(,0,P##s),ORDER_PP_TEST(8SEQ_FOR_EACH_WITH_IDX_,ORDER_PP_SYM_100_##i(,),NAT,LIT),ORDER_PP_LIT_INC_##i,P##f,ORDER_PP_EAT s##P),P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_PARTITION(P,f,s,...) ORDER_PP_8SEQ_PARTITION_4(,P##f,P##s,,,8PAIR,P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_SELECT(P,f,x,s,...) ORDER_PP_8SEQ_SELECT_3(,P##x,P##s,P##f,P##__VA_ARGS__)
#define ORDER_PP_8SEQ_SELECT_3(P,y,xs,f,...) (,P##y,ORDER_PP_SEQ_IS_NIL(,P##xs)(,,ORDER_PP_OPEN f##P,8AP,ORDER_PP_SEQ_AT(,0,P##xs),8SEQ_SELECT_B,P##y,ORDER_PP_SEQ_AT_0 xs##P,P##f,)P##__VA_ARGS__)
#define ORDER_PP_8SEQ_SELECT_B(P,b,y,x,...) ORDER_PP_CM_INVOKE(8SEQ_SELECT_3,ORDER_PP_IF_##b(,P##x,P##y)),P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_UNFOLD(P,x,c,s,f,...) ORDER_PP_8SEQ_UNFOLD_5(,P##x,P##c,P##s,P##f,,P##__VA_ARGS__)
