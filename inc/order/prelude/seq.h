...
#define ORDER_PP_8SEQ_PARTITION_B(P,b,f,x,in,ot,of,...) ORDER_PP_8SEQ_PARTITION_4(,P##f,P##in,ORDER_PP_LEFT(,ot##P)ORDER_PP_WHEN_##b(,(P##x)),ORDER_PP_LEFT(,of##P)ORDER_PP_UNLESS_##b(,(P##x)),P##__VA_ARGS__)
