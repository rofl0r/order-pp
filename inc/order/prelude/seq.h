...
#define ORDER_PP_DEF_8vseq_to_seq ORDER_PP_FN_CM(1,8VSEQ_TO_SEQ)
#define ORDER_PP_CM_8VSEQ_TO_SEQ(P,vs,...) (,ORDER_PP_CAT(ORDER_PP_VSEQ_TO_SEQ_A P##vs,0),P##__VA_ARGS__)

#define ORDER_PP_VSEQ_TO_SEQ_A(...) ((__VA_ARGS__))ORDER_PP_VSEQ_TO_SEQ_B
#define ORDER_PP_VSEQ_TO_SEQ_B(...) ((__VA_ARGS__))ORDER_PP_VSEQ_TO_SEQ_A
...
#define ORDER_PP_SEQ_PARENTHESIZE(P,s) ORDER_PP_CAT(ORDER_PP_SEQ_PARENTHESIZE_A P##s,8END)
