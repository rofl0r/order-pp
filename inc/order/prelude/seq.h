...
#define ORDER_PP_9SEQ_IOTA(P,i0,i1) ORDER_PP_FX(PM,ORDER_PP_8FOR_EACH_IN_RANGE(,P##i1,P##i0,(,8PUT_PARENTHESIZED),8STOP,))
...
#define ORDER_PP_8SEQ_SIZE(P,s,...) (,ORDER_PP_PM(,P##s,8SEQ_SIZE_TO_BINARY,)P##__VA_ARGS__)

#define ORDER_PP_8SEQ_SIZE_TO_BINARY(P,s,...) (,ORDER_PP_SEQ_TERMINATE(ORDER_PP_SEQ_SIZE_A P##s),
#define ORDER_PP_SEQ_SIZE_A(...) ORDER_PP_SEQ_SIZE_B
#define ORDER_PP_SEQ_SIZE_A0 ,8STOP,)0
#define ORDER_PP_SEQ_SIZE_B(...) ()ORDER_PP_SEQ_SIZE_C
#define ORDER_PP_SEQ_SIZE_B0 ,8SEQ_SIZE_TO_BINARY,)8BINARY_TO_DECIMAL,1
#define ORDER_PP_SEQ_SIZE_C(...) ORDER_PP_SEQ_SIZE_B
#define ORDER_PP_SEQ_SIZE_C0 ,8SEQ_SIZE_TO_BINARY,)8BINARY_TO_DECIMAL,0

#define ORDER_PP_8BINARY_TO_DECIMAL(P,sum,bit,...) (,ORDER_PP_EXPAND(ORDER_PP_IF_##bit(ORDER_PP_,NUM_INC,OPEN),(,ORDER_PP_NUM_BOP(,TIMES,2,P##sum))),P##__VA_ARGS__)
...
#define ORDER_PP_8SEQ_FOR_EACH_WITH_IDX(P,f,i,s,...) ORDER_PP_IS_EDIBLE(,P##i)(ORDER_PP_8SEQ_FOR_EACH_WITH_IDX_,NAT,LIT)(,,P##i,P##f,P##s,P##__VA_ARGS__)
