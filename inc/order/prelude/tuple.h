...
#define ORDER_PP_8TUPLE_AT(P,n,t,...) (,ORDER_PP_TUPLE_AT_##n t##P,P##__VA_ARGS__)
...
#define ORDER_PP_TUPLE_SIZE_B(P,_,_10,_9,_8,_7,_6,_5,_4,_3,_2,_1,x,...) x##P

#define ORDER_PP_DEF_8tuple_to_seq ORDER_PP_FN_CM(1,8TUPLE_TO_SEQ_2,)
#define ORDER_PP_8TUPLE_TO_SEQ_2(P,t,s,...) (,ORDER_PP_IS_TUPLE_SIZE_LT_10 t##P(,ORDER_PP_LEFT(,s##P)ORDER_PP_CAT(ORDER_PP_TUPLE_TO_SEQ_,ORDER_PP_TUPLE_SIZE t##P)t##P,(,ORDER_PP_TUPLE_REST_N_10 t##P),8TUPLE_TO_SEQ_2,ORDER_PP_LEFT(,s##P)ORDER_PP_TUPLE_TO_SEQ_10 t##P),P##__VA_ARGS__)
...
#define ORDER_PP_IS_TUPLE_SIZE_LT_10_B(_,_0,_1,_2,_3,_4,_5,_6,_7,_8,_9,x,...) ORDER_PP_TUPLE_AT_1(ORDER_PP_IF_,x,8false,)
