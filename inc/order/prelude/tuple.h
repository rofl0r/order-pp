...
#define ORDER_PP_CM_8TUPLE_TO_SEQ(P,t,...) (,ORDER_PP_TUPLE_ISNT_LONGER_THAN_10 t##P(,(,ORDER_PP_CAT(ORDER_PP_PTUPLE_TO_SEQ_,ORDER_PP_TUPLE_SIZE t##P(,ORDER_PP_OPEN_NP t##P))),(,ORDER_PP_TUPLE_REST_N_10 t##P),8PTUPLE_TO_SEQ_2,ORDER_PP_PTUPLE_TO_SEQ_FIRST_10 ORDER_PP_BLOCK(,ORDER_PP_OPEN_NP t##P)),P##__VA_ARGS__)
#define ORDER_PP_CM_8PTUPLE_TO_SEQ_2(P,t,s,...) (,ORDER_PP_PTUPLE_ISNT_LONGER_THAN_10 t##P(,(,ORDER_PP_OPEN(,s##P)ORDER_PP_CAT(ORDER_PP_PTUPLE_TO_SEQ_,ORDER_PP_PTUPLE_SIZE t##P)t##P),(,ORDER_PP_PTUPLE_REST_N_10 t##P),8PTUPLE_TO_SEQ_2,ORDER_PP_OPEN(,s##P)ORDER_PP_PTUPLE_TO_SEQ_FIRST_10 t##P),P##__VA_ARGS__)
...
#define ORDER_PP_TUPLE_ISNT_LONGER_THAN_10_B(_0,_1,_2,_3,_4,_5,_6,_7,_8,_9,x,...) ORDER_PP_PTUPLE_AT_1(,x,ORDER_PP_IF_OPEN_8false,)
