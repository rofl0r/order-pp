...
#define ORDER_PP_DEF_8tuple_at_0 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_0)
#define ORDER_PP_DEF_8tuple_at_1 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_1)
#define ORDER_PP_DEF_8tuple_at_2 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_2)
#define ORDER_PP_DEF_8tuple_at_3 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_3)
#define ORDER_PP_DEF_8tuple_at_4 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_4)
#define ORDER_PP_DEF_8tuple_at_5 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_5)
#define ORDER_PP_DEF_8tuple_at_6 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_6)
#define ORDER_PP_DEF_8tuple_at_7 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_7)
#define ORDER_PP_DEF_8tuple_at_8 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_8)
#define ORDER_PP_DEF_8tuple_at_9 ORDER_PP_FN_NATIVE(1,9TUPLE_AT_9)

#define ORDER_PP_9TUPLE_AT_0(P,t) ORDER_PP_FX(TUPLE_AT_0,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_1(P,t) ORDER_PP_FX(TUPLE_AT_1,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_2(P,t) ORDER_PP_FX(TUPLE_AT_2,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_3(P,t) ORDER_PP_FX(TUPLE_AT_3,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_4(P,t) ORDER_PP_FX(TUPLE_AT_4,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_5(P,t) ORDER_PP_FX(TUPLE_AT_5,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_6(P,t) ORDER_PP_FX(TUPLE_AT_6,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_7(P,t) ORDER_PP_FX(TUPLE_AT_7,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_8(P,t) ORDER_PP_FX(TUPLE_AT_8,(,ORDER_PP_REM t##P,))
#define ORDER_PP_9TUPLE_AT_9(P,t) ORDER_PP_FX(TUPLE_AT_9,(,ORDER_PP_REM t##P,))

#define ORDER_PP_DEF_8tuple_rest_n ORDER_PP_FN_NATIVE(2,9TUPLE_REST_N)
#define ORDER_PP_9TUPLE_REST_N(P,n,t) (ORDER_PP_TEST(ORDER_PP_TUPLE_REST_N_,ORDER_PP_IS_EDIBLE_TEST P##n,NAT,LIT)(,P##n,P##t))
...
#define ORDER_PP_DEF_8tuple_rest   ORDER_PP_FN_NATIVE(1,9TUPLE_REST_1)
#define ORDER_PP_DEF_8tuple_rest_1 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_1)
#define ORDER_PP_DEF_8tuple_rest_2 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_2)
#define ORDER_PP_DEF_8tuple_rest_3 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_3)
#define ORDER_PP_DEF_8tuple_rest_4 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_4)
#define ORDER_PP_DEF_8tuple_rest_5 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_5)
#define ORDER_PP_DEF_8tuple_rest_6 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_6)
#define ORDER_PP_DEF_8tuple_rest_7 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_7)
#define ORDER_PP_DEF_8tuple_rest_8 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_8)
#define ORDER_PP_DEF_8tuple_rest_9 ORDER_PP_FN_NATIVE(1,9TUPLE_REST_9)

#define ORDER_PP_9TUPLE_REST_1(P,t) (ORDER_PP_FX(TUPLE_REST_1,(,ORDER_PP_REM t##P)))
#define ORDER_PP_9TUPLE_REST_2(P,t) (ORDER_PP_FX(TUPLE_REST_2,(,ORDER_PP_REM t##P)))
#define ORDER_PP_9TUPLE_REST_3(P,t) (ORDER_PP_FX(TUPLE_REST_3,(,ORDER_PP_REM t##P)))
#define ORDER_PP_9TUPLE_REST_4(P,t) (ORDER_PP_FX(TUPLE_REST_4,(,ORDER_PP_REM t##P)))
#define ORDER_PP_9TUPLE_REST_5(P,t) (ORDER_PP_FX(TUPLE_REST_5,(,ORDER_PP_REM t##P)))
#define ORDER_PP_9TUPLE_REST_6(P,t) (ORDER_PP_FX(TUPLE_REST_6,(,ORDER_PP_REM t##P)))
#define ORDER_PP_9TUPLE_REST_7(P,t) (ORDER_PP_FX(TUPLE_REST_7,(,ORDER_PP_REM t##P)))
#define ORDER_PP_9TUPLE_REST_8(P,t) (ORDER_PP_FX(TUPLE_REST_8,(,ORDER_PP_REM t##P)))
#define ORDER_PP_9TUPLE_REST_9(P,t) (ORDER_PP_FX(TUPLE_REST_9,(,ORDER_PP_REM t##P)))

#define ORDER_PP_DEF_8tuple_size ORDER_PP_FN_NATIVE(1,9TUPLE_SIZE)
#define ORDER_PP_9TUPLE_SIZE(P,t) ORDER_PP_FY(TUPLE_SIZE,(,ORDER_PP_REM P##t))
...
#define ORDER_PP_DEF_8tuple_to_seq ORDER_PP_FN_NATIVE(1,9TUPLE_TO_SEQ)
#define ORDER_PP_9TUPLE_TO_SEQ(P,t) ORDER_PP_FY(TUPLE_TO_SEQ,(,ORDER_PP_REM P##t))
