...
#define ORDER_PP_TUPLE_TO_SEQ(P,t) ORDER_PP_IS_TUPLE_SIZE_LT_10 t##P(,ORDER_PP_CAT(ORDER_PP_TUPLE_TO_SEQ_,ORDER_PP_TUPLE_SIZE_MAX_10 t##P)t##P ORDER_PP_EAT,ORDER_PP_PM)(,(,ORDER_PP_TUPLE_REST_N_10 t##P),8TUPLE_TO_SEQ_2,ORDER_PP_TUPLE_TO_SEQ_FIRST_10 t##P,8EXIT,)
#define ORDER_PP_8TUPLE_TO_SEQ_2(P,t,s,...) (,ORDER_PP_IS_TUPLE_SIZE_LT_10 t##P(,ORDER_PP_LEFT(,s##P)ORDER_PP_CAT(ORDER_PP_TUPLE_TO_SEQ_,ORDER_PP_TUPLE_SIZE_MAX_10 t##P)t##P,(,ORDER_PP_TUPLE_REST_N_10 t##P),8TUPLE_TO_SEQ_2,ORDER_PP_LEFT(,s##P)ORDER_PP_TUPLE_TO_SEQ_FIRST_10 t##P),P##__VA_ARGS__)
