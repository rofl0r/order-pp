...
#define ORDER_PP_DEF_stringize ORDER_PP_FN_CM(1,8STRINGIZE)
#define ORDER_PP_CM_8STRINGIZE(P,x,...) (,#x,P##__VA_ARGS__)

#define ORDER_PP_DEF_expand ORDER_PP_CTOR_N(8EXPAND_)
#define ORDER_PP_DEF_expand_2 ORDER_PP_FN_CM(2,8EXPAND_2)
...
#define ORDER_PP_DEF_cat_2 ORDER_PP_FN_CM(2,8CAT_2)
