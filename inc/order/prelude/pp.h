...
#define ORDER_PP_9ADJACENT(P,l,r) ORDER_PP_LEFT(,l##P)P##r

#define ORDER_PP_DEF_8adjoin ORDER_PP_OP_LEFT_NATIVE(9ADJACENT,0IS_ANY)
...
#define ORDER_PP_9PASTE_PRECONDITION(P,l,r) ORDER_PP_ISNT_EDIBLE(,P##r)
