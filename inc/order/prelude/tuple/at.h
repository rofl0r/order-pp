...
#define ORDER_DEF_tuple_at ORDER_OP_CM(2,8TUPLE_AT)

#define ORDER_CM_8TUPLE_AT(P,t,n,...) (,ORDER_PP_EXPAND(ORDER_PP_TUPLE_AT_##n,(,ORDER_PP_OPEN_NP P##t,)),P##__VA_ARGS__)
