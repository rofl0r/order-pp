...
#define ORDER_PP_8LIT_DIV(P,r,l,...) (,ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_QUOTIENT_##l,)),P##__VA_ARGS__)
...
#define ORDER_PP_8LIT_MINUS(P,l,r,...) (,ORDER_PP_LIT_ASSERT(ORDER_PP_FX(TUPLE_AT_100_##r,(,ORDER_PP_LIT_MINUS_##l,))),P##__VA_ARGS__)
...
#define ORDER_PP_8LIT_PLUS(P,l,r,...) (,ORDER_PP_LIT_ASSERT(ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_PLUS_##l,))),P##__VA_ARGS__)

#define ORDER_PP_DEF_8lit_quotient ORDER_PP_FN_CM(2,8LIT_QUOTIENT)
#define ORDER_PP_8LIT_QUOTIENT(P,l,r,...) (,ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_QUOTIENT_##l,)),P##__VA_ARGS__)

#define ORDER_PP_DEF_8lit_remainder ORDER_PP_FN_CM(2,8LIT_REMAINDER)
#define ORDER_PP_8LIT_REMAINDER(P,l,r,...) (,ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_REMAINDER_##l,)),P##__VA_ARGS__)

#define ORDER_PP_DEF_8lit_sub ORDER_PP_OP_LEFT_CM(8LIT_SUB)
#define ORDER_PP_8LIT_SUB(P,r,l,...) (,ORDER_PP_LIT_ASSERT(ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_MINUS_##l,))),P##__VA_ARGS__)

#define ORDER_PP_DEF_8lit_times ORDER_PP_FN_CM(2,8LIT_TIMES)
#define ORDER_PP_8LIT_TIMES(P,l,r,...) (,ORDER_PP_LIT_ASSERT(ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_TIMES_##l,))),P##__VA_ARGS__)
...
#define ORDER_PP_LIT_LESS(P,l,r)      ORDER_PP_CAT(ORDER_PP_IF_,ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_LESS_##l,)))
#define ORDER_PP_LIT_MINUS(P,l,r)     ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_MINUS_##l,))
#define ORDER_PP_LIT_PLUS(P,l,r)      ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_PLUS_##l,))
#define ORDER_PP_LIT_QUOTIENT(P,l,r)  ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_QUOTIENT_##l,))
#define ORDER_PP_LIT_REMAINDER(P,l,r) ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_REMAINDER_##l,))
#define ORDER_PP_LIT_TIMES(P,l,r)     ORDER_PP_FX(TUPLE_AT_##r,(,ORDER_PP_LIT_TIMES_##l,))
