...
#define ORDER_PP_ENUM_PARAMS(P,i,n,p) ORDER_PP_NAT_IS_0 P##n(,ORDER_PP_EAT,ORDER_PP_CAT(P##p,ORDER_PP_NAT_TO_LIT(,P##i))ORDER_PP_ENUM_TRAILING_PARAMS)(,ORDER_PP_NAT_INC P##i,ORDER_PP_NAT_DEC P##n,P##p)
#define ORDER_PP_ENUM_TRAILING_PARAMS(P,i,n,p) ORDER_PP_ENUM_SCAN(ORDER_PP_OUTPUT(ORDER_PP_PM(,,8FOR_EACH_IN_RANGE_4,P##i,P##n,(,8EMIT_TRAILING_PARAM,P##p),8EXIT,)))
