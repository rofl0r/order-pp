...
#define ORDER_PP_8EMIT_SPACE(P,x,K,...) ORDER_PP_##K(,,P##__VA_ARGS__)(,2,,P##x)
...
#define ORDER_PP_ENUM_TRAILING_PARAMS(P,i0,i1,p) ORDER_PP_CM(,(,8EMIT_TRAILING_PARAM,P##p),8FOR_EACH_IN_RANGE,P##i1,P##i0,8STOP,)
