...
#define ORDER_PP_DEF_seq(...) ORDER_PP_SEQ_NUM_ARGS_8(__VA_ARGS__,9,8,7,6,5,4,3,2,1,)(__VA_ARGS__)

#define ORDER_PP_SEQ_NUM_ARGS_8(_,_8,_7,_6,_5,_4,_3,_2,_1,n,...) ORDER_PP_CTOR(n,8SEQ_##n)
