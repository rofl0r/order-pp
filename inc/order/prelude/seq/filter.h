...
#define ORDER_PP_CM_8SEQ_FILTER_3(P,f,out,in,...) (,ORDER_PP_IS_NOT_EDIBLE(,P##in)(,(,P##out),ORDER_PP_SEQ_FIRST(,P##in),ORDER_PP_OPEN P##f,8SEQ_FILTER_3_B,P##f,P##out,ORDER_PP_SEQ_TAKE_1 P##in),P##__VA_ARGS__)
