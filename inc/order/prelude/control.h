...
#define ORDER_PP_8FOR_EACH_IN_RANGE_4(P,_,f,lo,hi,...) (,ORDER_PP_SAME(,P##lo,P##hi)(,,P##lo,ORDER_PP_OPEN f##P,8FOR_EACH_IN_RANGE_4,P##f,ORDER_PP_INC_##lo,P##hi),P##__VA_ARGS__)
