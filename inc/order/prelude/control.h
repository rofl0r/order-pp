...
#define ORDER_PP_DEF_8when(t,...) 8EVAL_IF,t,8do(__VA_ARGS__),8nil
#define ORDER_PP_DEF_8unless(t,...) 8EVAL_IF,t,8nil,8do(__VA_ARGS__)

#define ORDER_PP_DEF_8for_each_in_range ORDER_PP_FN_CM(3,8PASS_NIL_4,8FOR_EACH_IN_RANGE_4)
