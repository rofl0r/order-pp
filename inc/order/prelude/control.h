...
#define ORDER_PP_DEF_for_each_in_range ORDER_PP_FN_CM(3,8FOR_EACH_IN_RANGE)
#define ORDER_PP_CM_8FOR_EACH_IN_RANGE(P,f,lo,hi,...) (,,8FOR_EACH_IN_RANGE_4,P##f,P##lo,P##hi,P##__VA_ARGS__)
