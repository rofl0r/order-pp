...
# define ORDER_PP_8NATIVE_LAST(P,n,m,ps,v) ORDER_PP_TEST(,ORDER_PP_##m##_PRECONDITION(,P##v)(,,,,),ORDER_PP_RIGHT(,P##m(P##v),8EXIT_ERROR,ORDER_PP_PRECONDITION_FAILURE,),ORDER_PP_##m)(,P##v)
...
# define ORDER_PP_8NATIVE_L_LAST(P,n,m,ps,vs) ORDER_PP_TEST(,ORDER_PP_##m##_PRECONDITION vs(,,,,),ORDER_PP_RIGHT(,m##P(ORDER_PP_BOTH P##vs),8EXIT_ERROR,ORDER_PP_PRECONDITION_FAILURE,),ORDER_PP_##m)vs
