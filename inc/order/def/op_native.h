...
# define ORDER_PP_8DEF_OP_LN_C(P,vr,e,m,vl,p,t,...) (,ORDER_PP_TYPE_CHECK(,P##p,P##vr,ORDER_PP_TEST)(,ORDER_PP_##m##_PRECONDITION(,P##vl,P##vr)(,,,,),ORDER_PP_RIGHT(,ORDER_PP_PRECONDITION_FAILURE,8EXIT_ERROR,P##m(P##vl,P##vr),),ORDER_PP_8DEF_OP_LN_C_B)(,P##e,P##t,P##m)(,P##vl,P##vr),P##p,P##__VA_ARGS__)
