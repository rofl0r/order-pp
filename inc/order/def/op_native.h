...
# define ORDER_PP_8DEF_OP_LN(P,e,m,p,ts,G,...) (,P##e,ORDER_PP_IS_EDIBLE(,P##ts)(,,8EXIT_SYNTAX_ERROR,P##m,)ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_FIRST ts##P())ORDER_PP_DEF_FIRST ts##P,8DEF_OP_LN_B,e##P,m##P,p##P,ORDER_PP_TUPLE_REST ts##P,P##__VA_ARGS__)
