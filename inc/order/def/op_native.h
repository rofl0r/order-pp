...
# define ORDER_PP_8DEF_OP_LN_B(P,v,e,m,p,t,...) (,ORDER_PP_TYPE_CHECK(,P##p,P##v,)P##e,ORDER_PP_SYNTAX_CHECK(,P##t,ORDER_PP_DEF)(P##t),8DEF_OP_LN_C,e##P,P##m,P##p,P##v,P##__VA_ARGS__)
# define ORDER_PP_8DEF_OP_LN_C(P,vr,e,m,p,vl,t,...) (,ORDER_PP_TYPE_CHECK(,P##p,P##vr,)P##e,ORDER_PP_SYNTAX_CHECK(,P##t,ORDER_PP_DEF)(P##t),8DEF_OP_LN_C,e##P,P##m,P##p,ORDER_PP_##p(,P##vr)(,ORDER_PP_##m,)(,P##vl,P##vr),P##__VA_ARGS__)
