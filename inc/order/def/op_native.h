...
#define ORDER_PP_8DEF_OP_LN(P,e,m,ts,G,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_FIRST ts##P())(,P##e,ORDER_PP_DEF_FIRST ts##P,8DEF_OP_LN_B,e##P,m##P,ORDER_PP_TUPLE_REST ts##P,P##__VA_ARGS__)
#define ORDER_PP_8DEF_OP_LN_B(P,v,e,m,t,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t)(,P##e,ORDER_PP_DEF_##t,8DEF_OP_LN_C,e##P,P##m,P##v,P##__VA_ARGS__)
#define ORDER_PP_8DEF_OP_LN_C(P,vr,e,m,vl,t,...) ORDER_PP_ASSERT_SYNTAX(ORDER_PP_DEF_##t)(,P##e,ORDER_PP_DEF_##t,8DEF_OP_LN_C,e##P,P##m,ORDER_PP_##m(,P##vl,P##vr),P##__VA_ARGS__)
#else
