...
# define ORDER_PP_8CM_LAST(P,v,n,K,ps) ORDER_PP_TEST(,ORDER_PP_##K##_PRECONDITION(,P##v)(,,,,),ORDER_PP_RIGHT(,P##K(P##v),8EXIT_ERROR,ORDER_PP_PRECONDITION_FAILURE,),)P##v,P##K
...
# define ORDER_PP_8CM_L_LAST(P,v,n,K,ps,vs) ORDER_PP_TEST(,ORDER_PP_##K##_PRECONDITION(,P##v,vs)(,,,,),ORDER_PP_RIGHT(,P##K(P##v,P##vs),8EXIT_ERROR,ORDER_PP_PRECONDITION_FAILURE,),)P##v,P##K,P##vs
