...
#define ORDER_PP_CTOR_N_PARAMS_B(P,...) ORDER_PP_TUPLE_SIZE(,P##__VA_ARGS__),(,ORDER_PP_TUPLE_REVERSE(,P##__VA_ARGS__))

#define ORDER_PP_8DEF_CTOR_N(P,e,cm,n,ts,...) (,P##e,ORDER_PP_DEF_FIRST ts##P,ORDER_PP_IS_1_##n(,,8DEF_CTOR_##n,(,ORDER_PP_TUPLE_REST ts##P),P##e,)cm##n,P##__VA_ARGS__)
