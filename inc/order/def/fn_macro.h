...
//
// The macro is invoked once all the actual parameters have been
...
// Defines an Order function implemented by a function-like macro,
// that must be passed a placemarker as the first actual parameter.
//
// - `arity' specifies the number of formal parameters of the macro,
...
//
// Placemarker concatenation inhibits macro expansion rescanning and
