...
#define ORDER_PP_CM_8DEF_CTOR_N(P,e,cm,n,ts,...) (,P##e,ORDER_PP_CTOR_DEF_LAST_##n P##ts,ORDER_PP_CTOR_UNLESS_IS_1_##n(,8DEF_CTOR_LEFT_##n,ORDER_PP_CTOR_OPEN_WITHOUT_LAST_##n P##ts,P##e,)cm##n,P##__VA_ARGS__)

#define ORDER_PP_CM_8DEF_CTOR_1(P,e,cm,p,...) (,P##e,ORDER_PP_DEF P##p,P##cm,P##__VA_ARGS__)
#define ORDER_PP_CM_8DEF_CTOR_2(P,e,cm,ts,...) (,P##e,ORDER_PP_CTOR_DEF_LAST_2 P##ts,8DEF_CTOR_LEFT_2,ORDER_PP_CTOR_OPEN_WITHOUT_LAST_2 P##ts,P##e,P##cm,P##__VA_ARGS__)
#define ORDER_PP_CM_8DEF_CTOR_3(P,e,cm,ts,...) (,P##e,ORDER_PP_CTOR_DEF_LAST_3 P##ts,8DEF_CTOR_LEFT_3,ORDER_PP_CTOR_OPEN_WITHOUT_LAST_3 P##ts,P##e,P##cm,P##__VA_ARGS__)
#define ORDER_PP_CM_8DEF_CTOR_4(P,e,cm,ts,...) (,P##e,ORDER_PP_CTOR_DEF_LAST_4 P##ts,8DEF_CTOR_LEFT_4,ORDER_PP_CTOR_OPEN_WITHOUT_LAST_4 P##ts,P##e,P##cm,P##__VA_ARGS__)
#define ORDER_PP_CM_8DEF_CTOR_5(P,e,cm,ts,...) (,P##e,ORDER_PP_CTOR_DEF_LAST_5 P##ts,8DEF_CTOR_LEFT_5,ORDER_PP_CTOR_OPEN_WITHOUT_LAST_5 P##ts,P##e,P##cm,P##__VA_ARGS__)
#define ORDER_PP_CM_8DEF_CTOR_6(P,e,cm,ts,...) (,P##e,ORDER_PP_CTOR_DEF_LAST_6 P##ts,8DEF_CTOR_LEFT_6,ORDER_PP_CTOR_OPEN_WITHOUT_LAST_6 P##ts,P##e,P##cm,P##__VA_ARGS__)
#define ORDER_PP_CM_8DEF_CTOR_7(P,e,cm,ts,...) (,P##e,ORDER_PP_CTOR_DEF_LAST_7 P##ts,8DEF_CTOR_LEFT_7,ORDER_PP_CTOR_OPEN_WITHOUT_LAST_7 P##ts,P##e,P##cm,P##__VA_ARGS__)
#define ORDER_PP_CM_8DEF_CTOR_8(P,e,cm,ts,...) (,P##e,ORDER_PP_CTOR_DEF_LAST_8 P##ts,8DEF_CTOR_LEFT_8,ORDER_PP_CTOR_OPEN_WITHOUT_LAST_8 P##ts,P##e,P##cm,P##__VA_ARGS__)
